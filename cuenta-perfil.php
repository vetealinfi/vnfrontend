									...
									<div class="row">
										<div class="col-md-3 col-sm-3">
											<section id="logotipo-vendedor">
												<figure class="agency-image"><img alt="" src="assets/img/logo-cuadrado.jpg"></figure>
											</section>
										</div>
										<div class="col-md-9 col-sm-9">
											<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-top: 0px; margin-left: -30px;">
