											...
											<div class="col-md-12 col-sm-12" style="margin-top: 0px; padding: 0px;">
												...
												<div class="agent-form">
													<form role="form" id="form-contact-agent" method="post"  class="form-horizontal clearfix">
														...
														<div class="form-group">
															<label for="inputEmail3" class="col-sm-3 control-label">Nueva contraseña</label>
															<div class="col-sm-9">
																<input type="password" class="form-control" id="nuevacontraseña" placeholder="">
															</div>
														</div>
														<div class="form-group">
															<label for="inputPassword3" class="col-sm-3 control-label">Repetir nueva contraseña</label>
															<div class="col-sm-9">
